...
var gameBoard = {
	...
	randomize : function(actor){
		var randomAngle=Math.floor(Math.random()*360);
		if((randomAngle==0)||(randomAngle%90==0))
		{
			randomAngle=45;
		}
		if(actor.controlType==gamely.CONTROL_TYPE.COMPUTER)
		{
			actor.angle=randomAngle;
		}
	}
};
