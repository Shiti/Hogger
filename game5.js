...
var gameBoard = {
	...
	drawLevelCleared: function(){
		context.fillText("Level cleared!!",this.boardWidth/2,this.boardHeight/2);
	},
...
function initialScreen() {
	...
	for(var i=0;i<numberOfBalls;i++)
	{
		...
		var tempRadius=Math.floor(tempEnergy/4);
	...
	setInterval(function(){
		...
		for(i in gameBoard.actors)
		{
			...
			{	
				...
				//actor.speed=Math.floor(actor.energy/12);
			}
		}
		...
		if(gameBoard.count==numberOfBalls-1)
		{
			context.fillStyle="black";
			gameBoard.drawLevelCleared();
		}
		else if(!gameBoard.isGameOver(playerBall))
		{
			gameBoard.redraw();		
			context.fillStyle='black';
